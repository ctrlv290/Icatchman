...
$fs_day = $n_syear . "-" . $n_smonth . "-" . $n_sday;
$es_day = $n_eyear . "-" . $n_emonth . "-" . $n_eday;
...
<tr>
	<td height=30 colspan=23 align="right">
	<a href="maintain_show_list.php?targetidx=<?echo $get_nodeidx;?>&startDay=<?echo $fs_day;?>&endDay=<?echo $es_day;?>" target="_new2" ><img src="webimg/print_icon.jpg" border=0 width="100" height="25"></a>&nbsp;
	<a href="excel_maintain_list.php?targetidx=<?echo $get_nodeidx;?>&startDay=<?echo $fs_day;?>&endDay=<?echo $es_day;?>"><img src="webimg/excel_icon.jpg" border=0 width="100" height="25"></a>
	</td>
</tr>
...
<?
$nowtoday = date("Y-m-d");
$sqlMaintain = " select * from maintain where site_idx = '".$get_pconum."' AND node_idx = '".$get_nodeidx."'  AND n_day >= '".$fs_day."' AND n_day <='".$es_day."' order by idx desc ";
